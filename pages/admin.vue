  ...
  <div>
    ...
    <NuxtLayout name="default">
      <div>
        ...
        <div>
          <div class="grid mt-8" :class="{'lg:grid-cols-[1fr_350px] gap-12': kidAction === 'delete' || kidAction === 'edit'}">
            <div>
              <div class="overflow-x-auto bg-white shadow ring-1 ring-black ring-opacity-5 sm:-mx-6 md:mx-0 md:rounded-lg dark:bg-primary-300">
