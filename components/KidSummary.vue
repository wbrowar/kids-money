...
<template>
  <div v-if="kid" class="@container/main">
    <NuxtLink
      class="block space-y-2 bg-white border border-primary-300 rounded-lg text-favorite"
